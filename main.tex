...
\begin{itemize}[itemsep=-2px, parsep=1pt, leftmargin=132pt]
    ...
    \item[\textbf{knowledge:}] Data Science, \textbf{Machine Learning}, Software Development, Electronic, Embedded System, etc.
...
\end{itemize}
 ...
 \headingBf{\href{}{Brain Tumor Image Segmentation (App) with MATLAB}}{Mar 2015 -- Present}
  ...
  \headingBf{\href{https://github.com/omarfarukof/Signal-Modulation-Simulator}{Signal Modulation Simulator (App) with MATLAB}}{Jan 2001 -- Present}
  \begin{resume_list}
    \item Maintained packages in Debian repositories
  \end{resume_list}
